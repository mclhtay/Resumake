...
/*!
 * \brief Stores volunteer information
 * \details This is a sub class of the Experience class which stores information about volunteer experiences and contains methods for storing and retrieving that information
 */
...
public:
    ...
    /*!
     * \brief resets volunteer experience
     * \details A function for clearing all stored volunteer experience data
     * \param none
     * \return none
     */
    void reset() override;
